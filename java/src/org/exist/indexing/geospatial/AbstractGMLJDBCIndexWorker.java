...
import org.geotools.gml.producer.GeometryTransformerWrapper;
...
public abstract class AbstractGMLJDBCIndexWorker implements IndexWorker {
    ...
    protected GeometryTransformerWrapper gmlTransformer = new GeometryTransformerWrapper();
    ...
    public IStoredNode getReindexRoot(IStoredNode node, NodePath path, boolean insert, boolean includeSelf) {
        ...
        for (int i = path.length() ; i > 0; i--) {
            ...
            if (currentNode.getParentNode() instanceof DocumentImpl)
                break;
            currentNode = (IStoredNode) currentNode.getParentNode();
        }
        return relevantNode;
    }
    ...
    public Element streamGeometryToElement(XQueryContext context, Geometry geometry, String srsName, Receiver receiver) throws SpatialIndexException {       
        //YES !!!
        ...
        try {
            ...
            //2) gmlPrefix
            //3) other stuff...
            //This will possibly require some changes in GeometryTransforme
